...
urlpatterns = [
    ...
    path(
        ...
        views.ProjectsDueInMonthAPIView.as_view(),
        name="api-projects-due-in-this-month",
    ),
    path(
        "import/",
    ...
    path(
        "stages/<int:pk>/",
        views.ProjectStageAPIView.as_view(),
        name="api-project-stage-detail",
    ),
    path("tasks/", views.TaskAPIView.as_view(), name="api-task-list"),
    path("tasks/my/", views.TasksMyAPIView.as_view(), name="api-task-my-list"),
    ...
    path(
        "timesheets/<int:pk>/",
        views.TimeSheetAPIView.as_view(),
        name="api-timesheet-detail",
    ),
]
