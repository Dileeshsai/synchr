...
urlpatterns = [
    ...
    path("assigned-leave-template/", AssignedLeaveTemplateAPIView.as_view()),
    path("assigned-leave-import/", AssignedLeaveImportAPIView.as_view()),
    path("assigned-leave-export/", AssignedLeaveExportAPIView.as_view()),
